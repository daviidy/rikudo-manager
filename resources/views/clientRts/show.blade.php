    ...
    <!--          <div class="col-md-6">
              ...
              <div class="col-md-12">
                ...
                <table class="table table-sm table-hover table-striped">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        A payé <strong>{{$factureRt->montant_de_paiement}} </strong>FCFA le <strong>{{ Carbon\Carbon::parse($factureRt->date_de_paiement)->format('d-m-Y') }}</strong>. Il reste
                        à payer <strong><p style="font-weight: bold; color: {{ $factureRt->reste != '0' ? '#F7761F' : "" }}" class="cell100 column4">{{$factureRt->reste}}</p></strong> FCFA.
                      </td>
                    </tr>
                    @endforeach
          ...
          <form action="{{ route('factureRts.store') }}" method="post" role="form">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <select name="client_rt_id" class="form-control" style="">
