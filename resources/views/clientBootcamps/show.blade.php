...
@section('title', $clientBootcamp->nom)
@section('content')
  ...
  <div class="container">
    <div class="row my-2">
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="tab-content py-4">
          ...
          <div class="tab-pane" id="edit" aria-expanded="true">
            <form enctype="multipart/form-data" role="form" action="{{ url('clientBootcamps', $clientBootcamp) }}" method="post">
              {{ csrf_field() }}
              {{ method_field('patch') }}
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Nom</label>
                <div class="col-lg-9">
                  <input name="nom" class="form-control" type="text" value="{{$clientBootcamp->nom}}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Prénoms</label>
                <div class="col-lg-9">
                  <input name="prenoms" class="form-control" type="text" value="{{$clientBootcamp->prenoms}}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Email</label>
                <div class="col-lg-9">
                  <input class="form-control" name="email" type="text" value="{{$clientBootcamp->email}}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Numéro</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" value="{{$clientBootcamp->numero}}" name="numero">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Thème</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" value="{{$clientBootcamp->theme}}" name="theme">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Métier</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" value="{{$clientBootcamp->metier}}" name="metier">
                </div>
              </div>
              <div class="form-group row">
          ...
          <form action="{{ route('factureBootcamps.store') }}" method="post" role="form">
              {{ csrf_field() }}
          ...
          <div class="tab-pane" id="delete" aria-expanded="false">
              <div class="form-group row">
                ...
                <form action="{{ route('clientBootcamps.destroy', $clientBootcamp) }}" method="post">
                    {{ csrf_field() }}
                    {{ method_field('delete') }}
      ...
      <div class="col-lg-4 order-lg-1 text-center">
        <img src="/img/usersPhotos/{{ $clientBootcamp->image }}" class="mx-auto img-fluid img-circle d-block" alt="avatar">
      </div>
    </div>
  </div>
