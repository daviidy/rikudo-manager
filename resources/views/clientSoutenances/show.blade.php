...
@section('title', $clientSoutenance->nom)
@section('content')
    ...
    <div class="row my-2">
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="tab-content py-4">
          <div class="tab-pane active" id="profile" aria-expanded="false">
            ...
            <div class="row">
              <div class="col-md-6">
                <h6>A propos de {{$clientSoutenance->nom}}</h6>
                <p>
                  Etudiant Soutenance pour Soutenance
                </p>
                <h6>Thème de mémoire</h6>
                <p>
      ...
      <!--        <div class="col-md-6">
              ...
              <div class="col-md-12">
                ...
                <table class="table table-sm table-hover table-striped">
                  <tbody>
                    <tr>
                      <td>
                        S'est inscrit à la formation le <strong>{{ $clientSoutenance->created_at }}</strong>
                      </td>
                    </tr>
                    @foreach($clientSoutenance->factureSoutenances as $factureSoutenance)
                    <tr>
                      <td>
                        A payé <strong>{{$factureSoutenance->montant_de_paiement}} </strong>FCFA le <strong>{{ Carbon\Carbon::parse($factureSoutenance->date_de_paiement)->format('d-m-Y') }}</strong>. Il reste
                        à payer <strong><p style="font-weight: bold; color: {{ $factureSoutenance->reste != '0' ? '#F7761F' : "" }}" class="cell100 column4">{{$factureSoutenance->reste}}</p></strong> FCFA.
                      </td>
                    </tr>
                    @endforeach
          ...
          <div class="tab-pane" id="edit" aria-expanded="true">
            <form enctype="multipart/form-data" role="form" action="{{ url('clientSoutenances', $clientSoutenance) }}" method="post">
              {{ csrf_field() }}
              {{ method_field('patch') }}
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Nom</label>
                <div class="col-lg-9">
                  <input name="nom" class="form-control" type="text" value="{{$clientSoutenance->nom}}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Prénoms</label>
                <div class="col-lg-9">
                  <input name="prenoms" class="form-control" type="text" value="{{$clientSoutenance->prenoms}}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Email</label>
                <div class="col-lg-9">
                  <input class="form-control" name="email" type="text" value="{{$clientSoutenance->email}}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Numéro</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" value="{{$clientSoutenance->numero}}" name="numero">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Filière</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" value="{{$clientSoutenance->filiere}}" name="filiere">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Thème</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" value="{{$clientSoutenance->theme}}" name="theme">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Diplome soutenu</label>
                <div>
          ...
          <form action="{{ route('factureSoutenances.store') }}" method="post" role="form">
              {{ csrf_field() }}
          ...
          <div class="tab-pane" id="delete" aria-expanded="false">
              <div class="form-group row">
                ...
                <form action="{{ route('clientSoutenances.destroy', $clientSoutenance) }}" method="post">
                    {{ csrf_field() }}
                    {{ method_field('delete') }}
      ...
      <div class="col-lg-4 order-lg-1 text-center">
        <img src="/img/usersPhotos/{{ $clientSoutenance->image }}" class="mx-auto img-fluid img-circle d-block" alt="avatar">
      </div>
    </div>
  </div>
